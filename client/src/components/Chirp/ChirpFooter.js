...
class ChirpFooter extends Component {
    render() {
        return (
            <>
              <div className="chirp-footer">
                <div className="comments">
                  ...
                  <div className="num-comments">{this.props.comments}</div>
                </div>
                <div className="rechirp">
                  ...
                  <div className="num-rechirps">{this.props.reChirps}</div>
                </div>
                <div className="star">
                  <svg
                    className="star-icon"
                  ...
                  <div className="num-stars">{this.props.stars}</div>
                </div>
              </div>                
            </>
        );
